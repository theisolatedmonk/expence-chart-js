...
function Balance(){
  return <div className="contain1 flex justify-between items-center bg-orange-600 h-24 rounded-xl px-4">
...
function TotalThisMonth(){
  return <div className="totalamtpercent flex justify-between">
